...
//		Rpc rpc = new Rpc("http://api.eosnewyork.io:80");
		//EosRpcService rpc = new EosRpcService("http://43.242.156.61:9008");
		//EosRpcService rpc = EosRpcService.newInstance("http://43.242.156.61:9008").newRestClient();
		EosApiRestClient rpc = EosApiClientFactory.newInstance("http://114.67.37.245:9008").newRestClient();
...
//			Transaction t1 = rpc.transfer("5KBWYsYudu9APDdUrHVPPDdyVMhjrRVq3zqDAEzhuogDR3caApb","machaoxiaoai", "machaoxiaoai","test12344444", "10.0000 SYS", "");
		...
		String pk = Ecc.seedPrivate(uuid);
		//String pk = Ecc.seedPrivate("81805b06b346d862b8386ad538da03b3cf220a7e5bce1510addc4311711ed3296c71e3fda664d222a33bbe1429bc4cf7c1b1f4526453899928281884afa2ca1e");
		System.out.println("private key :" + pk +"\n");
		System.out.println("============= 通过私钥生成公钥 ===============");
		String pu = Ecc.privateToPublic(pk);
	...
	/*	Account account = rpc.getAccount("udfstest");
		System.out.println(account.toString());*/
...
//					ActionTrace actionTrace = action.getActionTrace();
		...
		/*System.out.println("============= 创建账户不抵押 ===============");
		try {
			Transaction t3 = rpc.createAccount("5KAPo5n66XAJ4LkrW6MuQ25yCQzZFGRBVTfrtLUUyS3mB43XWGD","ulorduosudfs","tokyohot1111", "EOS8mmntVhDP4ZBXZhADGAqNzLWvLuQLnpG5HPdEpBtwrBL6z5x5p","EOS8mmntVhDP4ZBXZhADGAqNzLWvLuQLnpG5HPdEpBtwrBL6z5x5p", 3072l);
			System.out.println("创建成功 = " + t3.getTransactionId()+" \n ");
		}catch(Exception ex) {
			ex.printStackTrace();
		}*/
